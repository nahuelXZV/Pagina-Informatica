...
<footer class="shadow bg-[#00346f] ">
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="{{ route('welcome') }}" class=" justify-center items-center mb-4 sm:mb-0 md:hidden flex">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FICCT</span>
            </a>
        ...
        <span class="block text-sm text-white text-center sm:text-center">© 2023 <a href="{{ route('welcome') }}"
                class="hover:underline">Direccion de Ing. Informatica</a>. All
